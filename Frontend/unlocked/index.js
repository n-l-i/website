...
function load_window(){
    ...
    newScript.src = "http://localhost:5000/get_file/Frontend/unlocked/signin/signin.js";
    document.head.appendChild(newScript);
    newScript = document.createElement("script");
    newScript.src = "http://localhost:5000/get_file/Frontend/unlocked/signup/signup.js";
    document.head.appendChild(newScript);
    newScript = document.createElement("script");
